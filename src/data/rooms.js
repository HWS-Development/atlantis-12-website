...
const ROOMS = [
  ...
  },
  {
    ...
    images: [
      { src: `${ROOMS_PATH}/ipomea-chambre-lit-bleu-indigo-murs-pierre-atlantis12-essaouira.jpg`, alt: "L'Ipoméa, La chambre" },
      { src: `${ROOMS_PATH}/ipomea-salon-fauteuil-baroque-mur-bleu-indigo-atlantis12-essaouira.jpg`, alt: "L'Ipoméa, Le fauteuil baroque" },
      { src: `${ROOMS_PATH}/ipomea-salon-prive-cheminee-pierre-baies-vitrees-atlantis12-essaouira.jpg`, alt: "L'Ipoméa, Le salon" },
      { src: `${ROOMS_PATH}/ipomea-detail-vase-ambre-fleurs-sechees-pierre-atlantis12-essaouira.jpg`, alt: "L'Ipoméa, Détail décoration" },
      { src: `${ROOMS_PATH}/ipomea-salle-de-bain-voute-bleue-verriere-tadelakt-atlantis12-essaouira.jpg`, alt: "L'Ipoméa, La voûte bleue" },
  ...
  },
  {
    ...
    equip: COMMON_EQUIP_JUNIOR,
    images: [
      { src: `${ROOMS_PATH}/agave-chambre-lit-vert-murs-pierre-lumiere-atlantis12-essaouira.jpg`, alt: "L'Agave, La chambre" },
      { src: `${ROOMS_PATH}/agave-salon-fauteuil-pierre-atlantis12-essaouira.jpg`, alt: "L'Agave, Le salon" },
      { src: `${ROOMS_PATH}/agave-lit-double-murs-pierre-atlantis12-essaouira.jpg`, alt: "L'Agave, Le lit double" },
      { src: `${ROOMS_PATH}/agave-detail-coussin-textile-atlantis12-essaouira.jpg`, alt: "L'Agave, Détail coussin" },
      { src: `${ROOMS_PATH}/agave-detail-roses-rouges-table-basse-lit-coussins-verts-atlantis12-essaouira.jpg`, alt: "L'Agave, Détail fleurs" },
  ...
  },
  {
    ...
    equip: COMMON_EQUIP_JUNIOR,
    images: [
      { src: `${ROOMS_PATH}/coquelicot-chambre-lit-queen-coussins-rouges-lampes-raphia-murs-pierre-atlantis12-essaouira.jpg`, alt: "La Coquelicot, Le lit" },
      { src: `${ROOMS_PATH}/coquelicot-salon-arche-fenetre-coussins-rouges-poutres-atlantis12-essaouira.jpg`, alt: "La Coquelicot, Le salon" },
  ...
  },
  {
    ...
    equip: COMMON_EQUIP_JUNIOR,
    images: [
      { src: `${ROOMS_PATH}/orchis-chambre-lit-queen-couvre-lit-mauve-cheminee-murs-pierre-atlantis12-essaouira.jpg`, alt: "L'Orchis, Le lit" },
      { src: `${ROOMS_PATH}/orchis-detail-tete-de-lit-niche-pierre-bocaux-tablette-bois-atlantis12-essaouira.jpg`, alt: "L'Orchis, Détail tête de lit" },
