...
const ROOMS = [
  {
    ...
    images: [
      { src: `${ROOMS_PATH}/plumeria-suite-chambre-colonnes-vue-frontale-atlantis12-essaouira.webp`, alt: "La Pluméria, Détail du lit", position: "center 40%" },
      { src: `${ROOMS_PATH}/plumeria-terrasse-privee-baldaquin-foret-de-thuyas-atlantis12-essaouira.webp`, alt: "La Pluméria, Terrasse privée", position: "center bottom" },
      { src: `${ROOMS_PATH}/plumeria-salon-prive-oeuvre-lahcen-fikri-lumiere-atlantis12-essaouira.webp`, alt: "La Pluméria, Salon privé" },
      { src: `${ROOMS_PATH}/plumeria-cheminee-suspendue-metal-mur-pierre-atlantis12-essaouira.webp`, alt: "La Pluméria, La cheminée" },
      { src: `${ROOMS_PATH}/plumeria-salle-de-bains-zellige-turquoise-atlantis12-essaouira.webp`, alt: "La Pluméria, La salle de bain" },
      { src: `${ROOMS_PATH}/plumeria-detail-lit-coussins-artisanaux-marocains-atlantis12-essaouira.webp`, alt: "La Pluméria, Coussins artisanaux" },
    ],
  ...
  },
  {
    ...
    images: [
      ...
      { src: `${ROOMS_PATH}/ipomea-salle-de-bains-voute-bleue-verriere-tadelakt-atlantis12-essaouira.webp`, alt: "L'Ipoméa, La voûte bleue" },
